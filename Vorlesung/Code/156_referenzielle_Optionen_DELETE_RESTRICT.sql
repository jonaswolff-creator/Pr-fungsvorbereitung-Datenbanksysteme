...
CREATE TABLE Vorlesung (
    ...
    FOREIGN KEY (Personalnummer) 
        ...
        ON UPDATE CASCADE
        ON DELETE RESTRICT                       -- <-- RESTRICT als referenzielle Option
);
...
-- @block LÃ¶sche Dozent mit PrimÃ¤rschlÃ¼ssel 300 --> Fehler wegen "ON DELETE RESTRICT"
USE hans;
DELETE FROM Dozent WHERE Personalnummer=300;